...
<body>
    ...
    <img src="images/light.jpg" width="100%" class="img-fluid" alt="light.jpg">
	...
	<?php if (isset($_COOKIE['user']) == false) : ?>
		<figure class="text-center" id="authreg">
			...
			<br>
				...
				<button type="button" class="btn btn-outline-dark"  data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
					Авторизация
                </button> 
				<button type="button" class="btn btn-outline-dark" data-bs-toggle="offcanvas" href="#offcanvasReg" role="button" aria-controls="offcanvasExample">
					Регистрация
                </button>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="card-group">
				<div class="card">
					<img src="images/white1.jpg" class="card-img-top" style="height: 500px; object-fit: cover;" alt="white1.jpg">
					<div class="card-body">
						<p class="card-text">Лучший способ снимать с белым бекграундом — это снимать на циклораме. Каталог, портрет, мастер-класс или fashion — это не имеет значения.</p>
				
					</div>
				</div>
				<div class="card">
					<img src="images/white3.jpg" class="card-img-top" style="height: 500px; object-fit: cover;" alt="white2.jpg">
					<div class="card-body">
						<p class="card-text">Циклорама — прекрасно подходит почти для любых целей. 4500 мм шириной и почти 5 метров высотой.</p>
					
					</div>
				</div>
				<div class="card">
					<img src="images/white2.jpg" class="card-img-top" style="height: 500px; object-fit: cover;" alt="...">
					<div class="card-body">
						<p class="card-text">Циклорама позволяет снимать в полный рост группу из двух-трех моделей. Рекомендуемое фокусное растояние 35 мм для полнокадровых камер. </p>
    ...
    <h3 class="text-center" style="margin-top: 15px;">3 причины выбрать светлую студию</h3>
	<div class="container">
	...
	<div class="accordion-item">
	  ...
	  <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
		<div class="accordion-body">
		  <p>Белая студия — это студия-циклорама. Высокий, до шести метров потолок. Циклорама построена в трех измерениях (пол+стена+потолок) шириной 4,5 метра. Можно снимать в полный рост группу из двух моделей.</p>
		</div>
	  </div>
	</div>
	<div class="accordion-item">
	  ...
	  <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo">
		<div class="accordion-body">
		  <p>Мы используем студию для съемки моделей в полный рост, для фэшн каталогов и видео. Мы снимаем на full frame камеры объективами 35 и 50 мм. Если мы снимаем моделей в полный рост, то дистанция позволяет делать горизонтальные кадры на 35 мм и вертикальные на 50 мм.</p>
		</div>
	  </div>
	</div>
	<div class="accordion-item">
	  ...
	  <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree">
		<div class="accordion-body">
		  <p>В студии установлено импульсное и постоянное освещение. Импульсный свет IMPAX (USA) и LED Godox (China)</p>
		</div>
	  </div>
	</div>
  </div>
				...
				<div class="row">
					...
					<div class="col-md-3 col-6">
						...
						<ul class="nav list-unstyled justify-content-between">
							...
							<li class=""><a class="text-muted" href="https://vk.com/shadow201903"><img src="images/vk.svg" alt="vk.svg" width="36" height="36">
						</ul>
					</div>
				</div>
			</div>
