			...
			<div class="modal-content">
				...
				<form id="callback" class="form__body">
					<div class="mb-3">
						...
						<div class="mb-3" style="margin: 10px 10px 10px 10px;">
							<input class="form-control _req _date" id="exampleInputEmail1" type="date" name="Date" id="davaToday">
						</div>
				</form>
			</div>
...
<div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example" tabindex="0">
  <h2 id="scrollspyHeadingg1">7 дневный курс в группе</h2>
  <h6>Стоимость 5.6 тыс. рублей.</h6>
  <hr>
  <p style="margin-bottom:50px;">7-ми дневный курс не подразумевает становление хорошим фотографом. Вы будете заниматься в группе из 7 человек под предвадительством 2-х профессиональных фотографов, которые объяснять вам основы фотографии такие как: экспозиция, виды съемок, виды и типы фотообородувания.</p>
  <h2 id="scrollspyHeadingg2">30 дневный курс в группе</h2>
  <h6>Стоимость 18.7 тыс. рублей.</h6>
<hr>
  <p style="margin-bottom:50px;">В 30-ти дневном курсе вы получите больше больше знаний в области фотографий. Заниматься будете в группе из 10 человек под предводительством 3-х профессиональных фотографов. Вы узнаете как правильно ставить экспозицию, снимать в высоком и низком ключе. Практика фотографий будет проходить каждую неделю по 6 часов. Общее количество часов занятий 126 часов.</p>
  <h2 id="scrollspyHeadingg3">60 дневный курс в группе</h2>
  <h6>Стоимость 38 тыс. рублей.</h6>
<hr>
  <p style="margin-bottom:50px;">Полный курс фотографа, за который вы полностью освоите фотографию. И получите сертификат о прохождении полного курса.</p>
</div>
</div>
</div>
</div>
 ...
 <!-- Видос -->
<div class="container justify-content-center" style="align-items:center; margin-bottom: 25px;">
    <div class="row">
        <div class="col-sm-12 col-xxl-12">
<div class="ratio ratio-16x9">
  <iframe src="https://www.youtube.com/embed/_nmUI-QQFq8" title="YouTube video" ></iframe>
</div>
</div>
</div>
</div>
